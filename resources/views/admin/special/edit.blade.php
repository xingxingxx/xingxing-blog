        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{ route('admin.special.update',['id'=>$special->id]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea id="description" rows="10" class="form-control" name="description">{{ $special->description }}</textarea>
                                </div>
                            </div>
